...
const FASE1_CHECKLIST = ["Supplementen ingenomen (Enerxan, Biobasics, Proanthenols, MSM-plus, Omegold)?", "Voldoende gezond vet gegeten (doel: 3500–5000 kcal)?", "Voldoende water gedronken (2L)?", "Startfoto gemaakt?", "Gewogen vanochtend?"];
...
const FASE2_VOEDING = [
  { categorie: "Rundvlees", items: ["Biefstuk / magere steak", "Runderfilet", "Tartaar", "Extra mager rundergehakt"] },
  { categorie: "Kalfsvlees", items: ["Kalfsfilet", "Kalfsschnitzel – naturel"] },
  { categorie: "Gevogelte", items: ["Kipfilet", "Kiphaasjes", "Kalkoenfilet", "Kalkoenschnitzel – naturel"] },
  { categorie: "Varkensvlees", items: ["Varkenshaas"] },
  { categorie: "Vis", items: ["Kabeljauw", "Koolvis", "Schelvis", "Wijting", "Tong", "Tonijn", "Pangasius", "Tilapia", "Dorade"] },
  { categorie: "Zeevruchten", items: ["Garnalen", "Mosselen", "Krab", "Kreeft", "Inktvis / calamares – naturel"] },
  { categorie: "Ei", items: ["1 heel ei per dag", "Extra eiwit toegestaan"] },
  { categorie: "Sla & bladgroenten", items: ["IJsbergsla", "Kropsla / botersla", "Romaine / little gem", "Veldsla", "Rucola", "Radicchio", "Andijvie", "Spinazie", "Snijbiet"] },
  { categorie: "Koolsoorten", items: ["Broccoli", "Bloemkool", "Paksoi", "Witte kool", "Rode kool", "Savooiekool", "Chinese kool", "Spitskool", "Koolrabi"] },
  { categorie: "Bonen", items: ["Sperziebonen", "Snijbonen", "Haricots verts"] },
  { categorie: "Andere groenten", items: ["Komkommer", "Tomaat / cherrytomaat", "Paprika", "Courgette", "Aubergine", "Witlof", "Venkel", "Asperges", "Bleekselderij", "Radijs", "Artisjok"] },
  { categorie: "Kiemen", items: ["Taugé", "Alfalfa", "Tuinkers", "Bamboescheuten"] },
  { categorie: "Smaakmakers", items: ["Ui", "Rode ui", "Sjalot", "Prei", "Lente-ui", "Verse peper / chilipeper"] },
  { categorie: "Paddenstoelen", items: ["Champignons", "Kastanjechampignons", "Oesterzwammen", "Shiitake", "Cantharellen", "Andere verse paddenstoelen"] },
  { categorie: "Fruit", items: ["Appel – alle soorten", "Peer", "Aardbeien", "Frambozen", "Bramen", "Blauwe bessen", "Aalbessen", "Cranberries", "Kruisbessen", "Grapefruit", "Sinaasappel", "Mandarijn", "Citroen / citroensap", "Nectarine", "Perzik", "Pruim", "Kersen", "Abrikoos", "Mango", "Passievrucht", "Granaatappel", "Druiven", "Kiwi", "Ananas", "Meloen", "Papaja"] },
  { categorie: "Zuivel", items: ["Skyr naturel 0%", "Magere kwark", "Magere yoghurt naturel", "Hüttenkäse / cottage cheese"] },
  { categorie: "Plantaardige eiwitbronnen", items: ["Seitan – naturel", "Tofu – naturel", "Sojayoghurt – naturel, ongezoet"] },
  { categorie: "Eiwitpoeders", items: ["AH Clear Whey citroen-limoen", "More Clear Whey Lemonade", "ESN Isoclear Peach Iced Tea", "Upfront Clear Whey zwarte bes"] },
  { categorie: "Crackers & extra's", items: ["Wasa volkoren knäckebröd – maximaal 2 stuks per dag"] },
  { categorie: "Kruiden & smaakmakers", items: ["Verse kruiden", "Pure gedroogde kruiden & specerijen", "Knoflook", "Gember", "Azijn zonder toegevoegde suiker", "Citroen / limoen / citroen- en limoensap", "Chili", "Sambal", "Mosterd", "Bouillon / bouillonblokjes", "Wasabi / mierikswortel", "Tomatenpuree", "Augurken – zuur, zonder toegevoegde suiker", "Kappertjes"] },
  { categorie: "Sauzen & dips", items: ["Tabasco", "Kikkoman Natuurlijk Gebrouwen Sojasaus – maximaal 1 eetlepel per persoon per maaltijd", "Zelfgemaakte tzatziki op basis van skyr"] },
  { categorie: "Zoetstoffen", items: ["Erythritol", "Stevia", "Sucralose", "Acesulfaam-K", "Sacharine"] },
  { categorie: "Dranken", items: ["Water", "Bruiswater", "Water met citroen of limoen", "Koffie zonder suiker", "Thee en kruidenthee zonder suiker", "Light / zero frisdrank", "Suikervrije limonade", "Magere melk in koffie", "Clear whey met water"] },
];
...
const FASE3_VOEDING = [
  ...
  { categorie: "Groenten", items: ["Alle soorten groenten", "Zoete aardappel en maïs met mate", "Peulvruchten met mate"] },
  ...
  { categorie: "Zuivel & kaas", items: ["Naturel zuivel: mager of vol", "Alle soorten kaas"] },
  { categorie: "Noten", items: ["Alle soorten noten, ongebrand of gebrand"] },
  { categorie: "Eieren & eiwitproducten", items: ["Eieren", "Eiwitpoeder", "Whey", "Clear whey"] },
  { categorie: "Alcohol", items: ["Met mate"] },
  { categorie: "Haverzemelen", items: ["Met mate"] },
  { categorie: "Light sauzen & dressings", items: ["Remia Friteslijn Licht & Romig", "Remia Friteslijn Knoflook", "Remia Friteslijn Truffel", "Remia Friteslijn Sriracha", "Remia Fritessaus Zero", "Remia Curry Zero", "More – sauzen en saladedressings"] },
];
...
const FASE_LABELS = { 1: "Fase 1 — Bewust worden", 2: "Fase 2 — Vereenvoudigen", 3: "Fase 3 — Ontdekken & stabiliseren", 4: "Fase 4 — Persoonlijk ritme" };
...
function FaseChecklist({ phase, onClose }) {
  ...
  const list = phase === 1 ? FASE1_CHECKLIST : phase === 2 ? FASE2_CHECKLIST : phase === 3 ? FASE3_CHECKLIST : FASE4_CHECKLIST;
  const title = phase === 1 ? "Fase 1 checklist" : phase === 2 ? "Fase 2 checklist" : phase === 3 ? "Fase 3 checklist" : "Fase 4 checklist";
