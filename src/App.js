    ...
    <div style={{position:"fixed",inset:0,display:"flex",alignItems:"center",justifyContent:"center",zIndex:600,background:"rgba(0,0,0,0.5)",padding:24}}>
      <div style={{background:"white",borderRadius:24,padding:28,maxWidth:360,width:"100%",boxShadow:"0 20px 60px rgba(0,0,0,0.3)"}}>
        ...
        <div style={{display:"flex",gap:8,justifyContent:"center",marginBottom:20}}>
          {moods.map(m=>(
            <button key={m.emoji} onClick={()=>setMood(m.emoji)} style={{background:mood===m.emoji?"#d8f3dc":"#f4f1eb",border:mood===m.emoji?"2px solid #2d6a4f":"2px solid transparent",borderRadius:14,padding:"10px 8px",cursor:"pointer",textAlign:"center",flex:1}}>
  ...
  return (
    <div style={{position:"fixed",inset:0,display:"flex",alignItems:"center",justifyContent:"center",zIndex:600,background:"rgba(0,0,0,0.5)",padding:24}}>
      <div style={{background:"white",borderRadius:24,padding:28,maxWidth:360,width:"100%",boxShadow:"0 20px 60px rgba(0,0,0,0.3)",maxHeight:"80vh",overflowY:"auto"}}>
        ...
        <div style={{background:"#d8f3dc",borderRadius:99,height:8,marginBottom:20,overflow:"hidden"}}>
          <div style={{height:"100%",background:"#2d6a4f",borderRadius:99,width:`${(doneCount/list.length)*100}%`,transition:"width .3s"}}/>
        </div>
        {list.map(item=>(
          <div key={item} onClick={()=>toggle(item)} style={{display:"flex",alignItems:"center",gap:12,padding:"12px 0",borderBottom:"1px solid #f4f1eb",cursor:"pointer"}}>
            <div style={{width:24,height:24,borderRadius:6,border:checked[item]?"none":"2px solid #d1d5db",background:checked[item]?"#2d6a4f":"transparent",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,transition:"all .2s"}}>
              {checked[item]&&<div style={{color:"white",fontSize:14}}>✓</div>}
            </div>
...
export default function App() {
  ...
  useEffect(()=>{
    ...
    if (lastQuote !== today) {
      ...
      localStorage.setItem("hr-last-quote", today);
    }
  },[]);
          ...
          <div style={{padding:"16px 16px 0"}}>
            ...
            <div style={{display:"flex",gap:10,marginBottom:14}}>
              <button onClick={()=>setShowChecklist(true)} style={{flex:1,background:"white",border:"1.5px solid #e5e7eb",borderRadius:16,padding:"14px 8px",cursor:"pointer",textAlign:"center",boxShadow:"0 2px 8px rgba(0,0,0,0.05)"}}>
                ...
                <div style={{fontSize:11,color:"#2d6a4f",fontWeight:600,marginTop:4}}>Checklist</div>
              </button>
              <button onClick={()=>setShowMood(true)} style={{flex:1,background:"white",border:"1.5px solid #e5e7eb",borderRadius:16,padding:"14px 8px",cursor:"pointer",textAlign:"center",boxShadow:"0 2px 8px rgba(0,0,0,0.05)"}}>
                <div style={{fontSize:24}}>😊</div>
                <div style={{fontSize:11,color:"#2d6a4f",fontWeight:600,marginTop:4}}>Dagboek</div>
              </button>
              <button onClick={()=>setShowQuote(true)} style={{flex:1,background:"white",border:"1.5px solid #e5e7eb",borderRadius:16,padding:"14px 8px",cursor:"pointer",textAlign:"center",boxShadow:"0 2px 8px rgba(0,0,0,0.05)"}}>
                <div style={{fontSize:24}}>💬</div>
                <div style={{fontSize:11,color:"#2d6a4f",fontWeight:600,marginTop:4}}>Quote</div>
              </button>
            </div>
